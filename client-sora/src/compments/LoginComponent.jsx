...
function LoginComponent() {
  ...
  const handleSubmit = (event) => {
    ...
    // Use formData and selectedDate to perform your desired actions (e.g., API call)
    console.log('userData:', { ...formData, birthday: selectedDate });
  };

  return (
    <>        
      <section className="min-w-fit max-w-sm flex-col border bg-white px-6 py-14 shadow-md rounded-2xl">           
          <form className="flex flex-col text-sm p-3 rounded-md" onSubmit={handleSubmit}>
          ...
          <p className="flex justify-center text-sm text-gray-600">
            Already have an account?<a className="text-blue-500" href="#">
              Log in?
            </a>
          </p>
          ...
          <p className="mt-5 row-span-2 text-center text-sm text-gray-400">
            ...
            Company's <a className="text-blue-500" href="">
